          ...
          <div className="row justify mb-1em">
            <div className="col-12 col-xl-6 col-lg-8 col-md-8 col-sm-10 col-xs-10">
              <SegmentedControl
                ...
                controlRef={useRef()}
                defaultIndex={options.findIndex((opt) => opt.title === selectedOption)}
...
export const ContributorsPage = withServices<IWithoutDepInj, IWithDepInj>(ContributorsPageUnconnected, (services: IDependencyInjection) => ({
