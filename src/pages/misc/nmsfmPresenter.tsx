...
export const NmsfmPresenter: React.FC<IProps> = (props: IProps) => {
  ...
  return (
    <DefaultAnimation>
            ...
            <div className="col-12">
              ...
              <div className="view-queue">
                <CustomTooltip tooltipText="View tracks" position="left" theme="light">
                  <i className="material-icons action-icon noselect pointer" onClick={() => props.toggleTrackListOpen(true)}>
                    queue_music
                  </i>
                </CustomTooltip>
              </div>
      ...
      <BottomModalSheet isOpen={props.trackListIsOpen} onClose={() => props.toggleTrackListOpen(false)}>
