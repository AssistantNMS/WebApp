            ...
            <div className="content">
                <div className="container full pt1">
                    ...
                    <div className="row justify">
                        <a target="_blank" rel="noopener noreferrer" className="image store mt-3em" href="https://play.google.com/store/apps/details?id=com.kurtlourens.no_mans_sky_recipes&amp;ref=AssistantNMS" title="Download on the Play Store">
                            <img draggable="false" style={{ maxWidth: '100%' }} src="https://nmsassistant.com/assets/img/PlayStore.png" alt="google play store badge" />
                        </a>
                        <a target="_blank" rel="noopener noreferrer" className="image store mt-3em" href="https://apps.apple.com/us/app/id1480287625?ref=AssistantNMS" title="Download on the App Store">
