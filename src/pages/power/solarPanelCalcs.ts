export const getMinimumAmountOfSolarPanels = (powerKps: number): number =>
    Math.ceil(powerKps / 25);

export const getMinimumAmountOfBatteries = (powerKps: number): number =>
    Math.ceil((powerKps * 800) / 45000);
...
export const getTotalPowerConsSunrise = (totalPowerCons: number): number =>
    _safeMultiply(totalPowerCons, totalPowerConsSunriseMultiplier);
export const getTotalPowerConsDay = (totalPowerCons: number): number =>
    _safeMultiply(totalPowerCons, totalPowerConsDayMultiplier);
export const getTotalPowerConsSunsest = (totalPowerCons: number): number =>
    _safeMultiply(totalPowerCons, totalPowerConsSunsestMultiplier);
export const getTotalPowerConsNight = (totalPowerCons: number): number =>
...
export const getSolarPowerSunrise = (totalPowerCons: number): number =>
    _safeMultiply(totalPowerCons, solarPowerSunriseMultiplier);
export const getSolarPowerDay = (totalPowerCons: number): number =>
    _safeMultiply(totalPowerCons, solarPowerDayMultiplier);
export const getSolarPowerSunsest = (totalPowerCons: number): number =>
    _safeMultiply(totalPowerCons, solarPowerSunsestMultiplier);
export const getSolarPowerNight = (totalPowerCons: number): number =>
    _safeMultiply(totalPowerCons, solarPowerNightMultiplier);

const batteryCapacity = 45000.0;

export const getMaxPowerThatCanBeStored = (batteries: number): number =>
