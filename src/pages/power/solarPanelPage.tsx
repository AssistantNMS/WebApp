...
import {
  getMaxPowerThatCanBeStored,
  getMinimumAmountOfBatteries,
  getMinimumAmountOfSolarPanels,
  getSolarPowerDay,
  getSolarPowerNight,
  getSolarPowerSunrise,
  getSolarPowerSunsest,
} from './solarPanelCalcs';
...
const SolarPanelPageConnected: React.FC<IProps> = (props: IProps) => {
  ...
  const renderMinimumRequirements = (localRequiredKP: number) => {
    ...
    return (
      <>
        <div
          className={classNames('section row', {
            'not-recommended': showRecommended,
          })}
        >
        ...
        {showRecommended && (
          <div className="section row">
            <div className="col-12 mt-2em">
              <h4 className="solar-calc-warning">
                {translate(LocaleKey.solarPanelsProduceMoreThanBatteries)
        ...
        <div className="section row">
          <h3 className="col-xl-8 col-lg-10 col-md-12 col-sm-12 col-xs-12 heading mt-1em">{translate(LocaleKey.details)}</h3>
        </div>
        <div className="section row justify mt-1em">
          <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12">{totalPowerConsumedTable(localRequiredKP, props.selectedLanguage)}</div>
        ...
        <div className="section row justify">
          <h3 className="col-xl-8 col-lg-10 col-md-12 col-sm-12 col-xs-12 heading mt-1em">{translate(LocaleKey.info)}</h3>
        ...
        <div className="row full justify pt1">
            ...
            presenter={(data: any) => (
              <BasicLink key={data.link} href={data.link} additionalClassNames="gen-item-container">
                ...
                <div className="gen-item-content-container">
                  ...
                  <ActionContainer
                    actions={[
                      <i key="open in new tab" className="material-icons mr-3">
                        open_in_new
                      </i>,
                    ]}
                  />
          ...
          <div className="col-6">
            <form id="searchBar" className="searchbar row noselect">
              <input type="number" className="form-control ta-center" placeholder="..." value={requiredKP ?? ''} onChange={onSearchTextChange} />
            </form>
          </div>
          <div className="col-3"></div>
        </div>
