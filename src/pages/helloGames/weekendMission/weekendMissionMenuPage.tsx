...
export const WeekendMissionMenuPresenter: React.FC = () => {
  const weekendMissionCard = (title: string, imageName: string, credits: string, seasonId: string, external?: string) => {
    if (external != null) {
      return (
        <a
          href={external}
          ...
          className={classNames('col-12 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-cs-12 weekend-mission-card')}
