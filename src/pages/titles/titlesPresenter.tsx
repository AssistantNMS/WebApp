...
export const TitlesPresenter: React.FC<IProps> = (props: IProps) => {
  const getFloatingActionButtons = (): Array<JSX.Element> => {
      ...
      <DefaultAnimation>
        <div className="content">
          <SearchBar
            ...
            onSearchTextChange={(e: React.ChangeEvent<HTMLInputElement>) => props.setSearch(e?.target?.value ?? props.searchTerm)}
          />
  ...
  return (
    <>
      <HeadComponent title={translate(LocaleKey.titles)} description={translate(LocaleKey.titles)} selectedLanguage={props.selectedLanguage} />
