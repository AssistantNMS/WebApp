    ...
    <div className="container" data-id="SmallLoading">
      <div className="row">
        <div className="col-12" style={{ textAlign: 'center' }}>
          <img src="/assets/images/loader.svg" draggable="false" alt="loading-animation" style={{ maxWidth: props?.maxWidth ?? '100px' }} />
          {props.hideText !== true && <h2 className="largeHeading">Loading...</h2>}
        </div>
      </div>
    </div>
  );
