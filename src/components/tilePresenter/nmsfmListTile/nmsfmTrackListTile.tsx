        ...
        <div className="gen-item-container h-full w-full" draggable={false}>
            <div className="gen-item-content-container pr-6">
                <TextContainer text={props.title}
                    additionalCss={classNames('m-0-child', 'f-1', { multiline })}
                />
                {
                    props.artist &&
                    <div className="quantity-container mb-2">{props.artist}</div>
                }
                {/* <ActionContainer
...
export const getTrackIcon = (trackType: NmsfmTrackType): string => {
    switch (trackType) {
        case NmsfmTrackType.track: return 'library_music';
        case NmsfmTrackType.advert: return 'campaign';
        case NmsfmTrackType.jingle: return 'audiotrack';
        case NmsfmTrackType.radioShow: return 'mic';
    }
    return '';
};
