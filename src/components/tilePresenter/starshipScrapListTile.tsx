...
import {
  starshipScrapClassType,
  starshipScrapShipClassImage,
  starshipScrapShipImage,
  starshipScrapShipType,
} from './rewardFromTile/rewardFromStarshipScrapPresenter';
...
export const StarshipScrapListTile: React.FC<IProps> = (props: IProps) => {
  return (
    <div
      key={props.scrap.ShipType + props.scrap.ShipClassType + ' ' + props.index}
      data-id="StarshipScrapListTile"
      className="gen-item-container noselect pointer"
      draggable={false}
    ...
    >
      ...
      <div className="gen-item-content-container">
        ...
        <div className="quantity-container">{starshipScrapClassType(props.scrap.ShipClassType) + ' class'}</div>
        <ActionContainer
          actions={[
            <i key="expand" onClick={() => props.setIsExpanded(!props.isExpanded)} className="material-icons x2">
...
export const StarshipScrapItemDetailListTileClass: React.FC<IDetailListProps> = (props: IDetailListProps) => {
  ...
  return (
    <Link
      to={`${catalogueItem}/${props.details.Id}`}
      data-id="StarshipScrapItemDetailListTile"
    ...
    >
      ...
      <div className="gen-item-content-container">
        ...
        {subtitleText.length > 1 && <div className="quantity-container">{subtitleText}</div>}
...
export const StarshipScrapItemDetailListTile = withServices<
  IStarshipScrapItemDetailListTileWithoutDepInj,
  IStarshipScrapItemDetailListTileWithDepInj
>(StarshipScrapItemDetailListTileClass, (services: IDependencyInjection) => ({
  gameItemService: services.gameItemService,
}));

export const StarshipScrapItemDetailListTilePresenter = (starship: StarshipScrapItemDetail, index: number): JSX.Element => (
  <StarshipScrapItemDetailListTile details={starship} index={index} />
);
