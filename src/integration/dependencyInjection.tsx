...
export const DependencyInjectionProvider: React.FC<IDependencyInjectionProviderProps> = (props: IDependencyInjectionProviderProps) => {
  ...
  return <DependencyInjectionContext.Provider value={defaultDependencyInjectionFunc()}>{children}</DependencyInjectionContext.Provider>;
};
...
export function withDependencyInjectionConsumer<WithoutExpectedDependencyInjectionType, ExpectedDependencyInjectionType>(
  WrappedComponent: any,
  mapper: (DependencyInjection: IDependencyInjection) => ExpectedDependencyInjectionType,
) {
  const wrapper: React.FC<WithoutExpectedDependencyInjectionType> = (props: WithoutExpectedDependencyInjectionType) => {
    return (
      <DependencyInjectionContext.Consumer>
        {(DependencyInjection: IDependencyInjection) => <WrappedComponent {...mapper(DependencyInjection)} {...props} />}
      </DependencyInjectionContext.Consumer>
    );
  };
  return wrapper;
...
export function withServices<WithoutExpectedServicesType, ExpectedServicesType>(
  WrappedComponent: any,
  mapper: (services: IDependencyInjection) => ExpectedServicesType,
) {
  const wrapper: React.FC<WithoutExpectedServicesType> = (props: WithoutExpectedServicesType) => {
    return (
      <DependencyInjectionContext.Consumer>
        {(services: IDependencyInjection) => <WrappedComponent {...mapper(services)} {...props} />}
      </DependencyInjectionContext.Consumer>
    );
  };
  return wrapper;
