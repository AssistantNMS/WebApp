export class AppImage {
    ...
    static eggIncreasing = (): string => AppImage.base() + 'special/increasing.png';
    static eggDecreasing = (): string => AppImage.base() + 'special/decreasing.png';
    ...
    static platformNsw = (): string => AppImage.base() + 'platformNsw.png';
